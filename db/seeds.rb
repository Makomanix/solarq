...
Question.create(text: "What ancient culture can claim the first written report of Halley's Comet?", difficulty: "hard", points: 300, category: "other", answer: "China", option1: "Chinese", option2: "Greek", option3: "Egyptian", option4: "Persian", hint: "They also invented the umbrella", solar_object_id: 19)
...
Question.create(text: "What moon contains the only hydrological cycle outside of Earth?", difficulty: "hard", points: 300, category: "moon", answer: "Titan", option1: "Titan", option2: "1", option3: "0", option4: "4", hint: "You can do it!", solar_object_id: 15)
Question.create(text: "How many moons does Mars have?", difficulty: "easy", points: 100, category: "other", answer: "2", option1: "2", option2: "1", option3: "0", option4: "4", hint: "You can do it!", solar_object_id: 12)
Question.create(text: "How many moons does Mars have?", difficulty: "medium", points: 200, category: "other", answer: "2", option1: "2", option2: "1", option3: "0", option4: "4", hint: "You can do it!", solar_object_id: 12)
Question.create(text: "How many moons does Mars have?", difficulty: "hard", points: 300, category: "other", answer: "2", option1: "2", option2: "1", option3: "0", option4: "4", hint: "You can do it!", solar_object_id: 12)    